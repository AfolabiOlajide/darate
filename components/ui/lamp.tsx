...
export default function LampDemo() {
  return (
    <LampContainer>
      ...
      >
        Generosity Meets Innovation <br /> Donate the right way <br /> on Darate
      </motion.h1>
    </LampContainer>
  );
}
    ...
    >
      <div className="relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0 ">
        ...
        <motion.div
          ...
          className="absolute inset-auto z-30 h-36 w-64 -translate-y-[6rem] rounded-full bg-brand/90 blur-2xl"
        ></motion.div>
        <motion.div
          initial={{ width: "15rem" }}
          ...
          className="absolute inset-auto z-50 h-0.5 w-[30rem] -translate-y-[7rem] bg-brand/90 "
        ></motion.div>
