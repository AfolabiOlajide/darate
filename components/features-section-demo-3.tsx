...
export default function FeaturesSectionDemo() {
  const features = [
    {
      title: "Create Campaigns or organizations Effectively",
      description:
        "Launch impactful campaigns to reach your goals or establish non-profit organizations to drive your mission forward—all with ease and transparency",
    ...
    },
    {
      ...
      description:
        "Support campaigns securely and transparently with blockchain-powered crypto donations, ensuring efficiency and trust in every contribution.",
    ...
    },
    {
      ...
      description:
        "Darate is powered by the Request Network to enable secure, censorship-resistant donations with transparent tracking and decentralized invoicing.",
        ...
        "col-span-1 lg:col-span-3 lg:border-r  border-neutral-800",    },
    {
      title: "Global Access",
      description:
        "With our decentralized structure, you can create and support campaigns from anywhere in the world without restrictions.",
    ...
    <div className="relative z-20 py-10 lg:py-40 max-w-7xl mx-auto">
      <div className="px-8">
        ...
        <p className="text-sm lg:text-base  max-w-2xl  my-4 mx-auto text-neutral-300 text-center font-normal dark:text-neutral-300">
          From creating campaigns or organizations to donating to exciting projects or non-profit that resonates with your values, our platform has you covered.
        </p>
      </div>
...
const FeatureTitle = ({ children }: { children?: React.ReactNode }) => {
  return (
    <p className=" max-w-5xl mx-auto text-left tracking-tight text-white dark:text-white text-xl md:text-2xl md:leading-snug font">
      {children}
    </p>
  );
};
...
export const SkeletonThree = () => {
  return (
    <Link
      href="https://youtu.be/XEuuiLKsqCE"
      target="__blank"
      ...
      <div className="flex flex-row -ml-20">
        {images.map((image, idx) => (
          <motion.div
            ...
            whileTap="whileTap"
            className="rounded-xl -mr-4 mt-4 p-1 bg-neutral-800 dark:bg-neutral-800 dark:border-neutral-700 border border-neutral-700 flex-shrink-0 overflow-hidden"
          >
            <Image
              src={image}
              alt="bali images"
